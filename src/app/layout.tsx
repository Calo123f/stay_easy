export const metadata = {
  title: 'StayEasy - Find the perfect accommodation',
  description: 'Compare and book accommodations from multiple sources at the best prices',
};
          ...
          <div className="container mx-auto px-4 py-4">
            <div className="flex justify-between items-center">
              ...
              <div className="hidden md:flex space-x-4">
                <button className="px-4 py-2 rounded-md bg-white text-blue-600 border border-blue-600">
                  Sign In
                </button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div>
                ...
                <p className="text-gray-300">
                  Find the perfect accommodation from multiple sources at the best prices.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  ...
                  <li><a href="/itinerary" className="text-gray-300 hover:text-white">Trip Planner</a></li>
                </ul>
              </div>
